...
# Winter 2024
# Assignment 3: Basic Math Structures
# Haroon Ahmed
...
def q3():
    ...
    print("Sum Squares: ", sum_counting_formula(n), sum_squares_loop(n))
    print("Sum Cubes: ", sum_counting_formula(n), sum_cubes_loop(n))
    print("Sum Geometric: ", sum_counting_formula(n), sum_geometric_loop(n, a, r))
    print("Sum Arithmetic: ", sum_counting_formula(n), sum_arithmetic_loop(n, a, d))

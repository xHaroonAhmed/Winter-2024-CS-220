...
def analyze_truth_table(f, verbose=False):
   ...
   return tt_vars, tt_cols, tt_rows, tt_type, last_col, binary, int(binary, 2)
...
def main():
    ...
    functions = [f0_false, f1_nor, f2_converse_nonimpl, f3_not_p, f4_not_impl, f5_not_q, f6_xor, f7_nand, f8_and, f9_xnor, f10_q, f11_imply, f12_p, f13_converse, f14_or, f15_True]
